...
class Prescription_model extends CI_Model {
    ...
    public function getPrescriptionByIPD($id, $visitid = '') {
        ...
        $query = $this->db->select('ipd_prescription_details.*,medicine_category.medicine_category,staff.id as staff_id,medicine_dosage.dosage, medicine_dosage.id as dosageid, ipd_prescription_basic.*')
