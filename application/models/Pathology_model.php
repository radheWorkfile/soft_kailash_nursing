...
class Pathology_model extends CI_Model
{
    ...
    public function getBillDetails($id)
    {
        ...
        $this->db->select('pathology_report.*,pathology.test_name,pathology.short_name,pathology.report_days,patients.patient_name,staff.name as doctor_name,patients.mobileno,patients.email,patients.dob,patients.gender,patients.marital_status,patients.blood_group,patients.address,patients.guardian_name');
