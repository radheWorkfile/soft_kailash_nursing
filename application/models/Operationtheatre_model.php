...
class Operationtheatre_model extends CI_Model {
    ...
    public function getBillDetails($id) {
        $this->db->select('operation_theatre.*,patients.patient_name,staff.name as doctor_name,patients.mobileno,patients.email,patients.dob,patients.gender,patients.marital_status,patients.blood_group,patients.address,patients.guardian_name');
