...
class Pharmacy_model extends CI_Model
{
    ...
    public function searchFullText()
    {
        ...
        $this->db->select('pharmacy.*,medicine_category.id as medicine_category_id,medicine_category.medicine_category, mbd.mrp,mbd.batch_no,mbd.available_quantity as total_qty');
        $this->db->join('medicine_category', 'pharmacy.medicine_category_id = medicine_category.id', 'left');
        $this->db->join('medicine_batch_details as mbd', 'mbd.pharmacy_id = pharmacy.id', 'left');
    ...
    // public function all_avl_amt() {

    //     $this->sb->select('');
    //     $this->db->where();
    //     $this->db->join('pharmacy as p', 'p.');
    //     $val = $this->db->get('medicine_batch_details as mbd');
    ...
    public function getBillDetails($id)
    {
        ...
        $this->db->select('pharmacy_bill_basic.*,staff.name,staff.surname,patients.patient_name,patients.id as patientid,patients.patient_unique_id,patients.mobileno,patients.email,patients.dob,patients.gender,patients.marital_status,patients.blood_group,patients.address,patients.guardian_name');
