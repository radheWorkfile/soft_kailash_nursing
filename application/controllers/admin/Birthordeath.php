...
class Birthordeath extends Admin_Controller {
    ...
    public function addDeathdata() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $death_date = strftime('%Y-%m-%dT%H:%M:%S', strtotime($deathdate));
            //date('Y-m-d H:i:s', $this->customlib->datetostrtotime($deathdate));
    ...
    public function addBirthdata() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $birth_date = strftime('%Y-%m-%dT%H:%M:%S', strtotime($birthdate));
