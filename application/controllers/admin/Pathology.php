...
class Pathology extends Admin_Controller {
    ...
    public function add() {
        ...
        $this->form_validation->set_rules('test_center_name', $this->lang->line('test') . " " . "Center " . $this->lang->line('name'), 'required');
        ...
        if ($this->form_validation->run() == FALSE) {
            $msg = array(
                'test_center_name' => form_error('test_center_name'),
            ...
            $pathology = array(
                'test_center_name' => $this->input->post('test_center_name'),
    ...
    public function search() {
        ...
        $data["title"] = 'add_patho_patient_test_report';
