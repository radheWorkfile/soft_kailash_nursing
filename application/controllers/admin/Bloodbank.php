...
class Bloodbank extends Admin_Controller {
    ...
    public function addIssue() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $bloodissue = array(
                'date_of_issue' => strftime('%Y-%m-%dT%H:%M:%S', strtotime($issue_date)),//date('Y-m-d H:i:s', $this->customlib->datetostrtotime($issue_date)),
                'bill_no' => $bill,
    ...
    public function donorCycle() {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $donor_cycle = array(
                ...
                'donate_date' =>strftime('%Y-%m-%dT%H:%M:%S', strtotime($donate_date))
            );
