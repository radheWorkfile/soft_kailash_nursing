...
$agent = $this->agent_model->get_agent($result['agent_details']);
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mb0 font13">
                                <tbody>
                                    ...
                                    <tr>
                                        <th class="bozerotop"><?php echo $this->lang->line('agent'); ?></th>
                                        <td class="bozerotop"><?php echo empty($agent['name']) ? "Direct" : $agent['name'] . "(" . $agent['agent_id'] . ")"; ?></td>
                                        <th class="bozerotop"><?php echo "Registration " . $this->lang->line('id'); ?></th>
                                    ...
                                    <tr>
                                        <th class="bozerotop"><?php
                                                                ...
                                                                ?></th>
                                                                <?php //echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['date'])) ?>
                                        <td class="bozerotop"><?php echo $result['date']. " " . date("h:i A", strtotime($result['time']))  ?></td>
                                        <th class="bozerotop"><?php
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right">
                                                            <?php if ($this->rbac->hasPrivilege('consultant register', 'can_delete')) { ?><a class="btn btn-default btn-xs" data-toggle="tooltip" title="" onclick="delete_record('<?php echo base_url(); ?>admin/patient/deleteIpdPatientConsultant/<?php echo $consultant_value['patient_id']; ?>/<?php echo $consultant_value['id']; ?>', '<?php echo $this->lang->line('delete_message'); ?>')" data-original-title="<?php echo $this->lang->line('delete'); ?>">
                            ...
                            <?php if ($this->rbac->hasPrivilege('ipd_prescription ', 'can_view')) { ?>
                                ...
                                <div class="tab-pane" id="diagnosis">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover example">
                                            <thead>
                                                <th><?php echo "Diagnosis Center Name"; ?></th>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <td><?php echo $diagnosis_value["diagnosis_center_name"] ?></td>
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                ?>
                                                                        <a onclick="editDiagnosis('<?php echo $diagnosis_value['id']; ?>')" class="btn btn-default btn-xs" data-toggle="tooltip" title="" data-original-title="<?php echo $this->lang->line('edit'); ?>">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover example">
                                        <thead>
                                            ...
                                            <th class="text-right"><?php echo $this->lang->line('unit'); ?>/Days</th>
                                            <th class="text-right"><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . ' (' . $currency_symbol . ')'; ?></th>
                                          <th class="text-right"><?php echo $this->lang->line('total') . " " . $this->lang->line('charge') . ' (' . $currency_symbol . ')'; ?></th>
                                            <th class="text-right"><?php echo $this->lang->line('action') ?></th>
                                        </thead>
                                        <tbody>
                                            <?php
                                            ...
                                            if (!empty($charges)) {
                                                ...
                                                foreach ($charges as $charge) {
                                                    ...
                                                    $total += $charge["unit"] * $charge["apply_charge"];
                                            ?>
                                                    <tr>
                                                        ...
                                                        <td class="text-right"><?php echo $charge["unit"] ?></td>
                                                        <td class="text-right"><?php echo $charge["apply_charge"] ?></td>
                                                      <td class="text-right"><?php echo number_format($charge["unit"] * $charge["apply_charge"],2); ?></td>
                                                        <td class="text-right">
                                        ...
                                        <tr class="box box-solid total-bg">
                                            <td colspan='8' class="text-right"><?php echo $this->lang->line('total') . " : " . $currency_symbol . "" . $total ?> <input type="hidden" id="charge_total" name="charge_total" value="<?php echo $total ?>">
                                            </td>
                                            <td></td>
                                        </tr>
                                    </table>
                                        ...
                                        <div class="table-responsive" style="border: 1px solid #dadada;border-radius: 2px; padding: 10px;">
                                            ...
                                            <table class="nobordertable table table-striped">
                                                <tr>
                                                    ...
                                                    <th width="19%"><?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') ?></th>
                                                    <th width="19%"><?php echo $this->lang->line('unit') ?></th>
                                                    <th width="19%"><?php echo $this->lang->line('applied') . " " . $this->lang->line('charge'); ?></th>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td class="pttright reborder"><?php echo $amt; ?></td>
                                                    </tr>
                                                    <?php
                                                    $total += $amt;
                                                    ?>
                                                ...
                                                <tr class="box box-solid total-bg">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td class="text-right" colspan="2"><?php echo $this->lang->line('total') . " : "; ?> <?php echo $currency_symbol . $total ?></td>
                                                    ...
                                                    <?php if ($result['ipd_discharge'] != 'paid') { ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php
                                                                                                ...
                                                                                                ?>
                                                                <input type="hidden" value="<?php echo $paid_amount ?>" id="paid_amount" name="paid_amount" style="width: 30%" class="form-control">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right ipdbilltable">
                                                                ...
                                                                <input type="text" id="discount" value="<?php
                                                                                                        ...
                                                                                                        ?>" name="discount" style="width: 30%; float: right" class="form-control">
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20">
                                                                ...
                                                                <span id="net_amount_span" class="">0</span><input type="hidden" name="net_amount" value="<?php
                                                                                                                                                            ...
                                                                                                                                                            ?>" id="net_amount" style="width: 30%; float: right" class="form-control">
                                                            </td>
                                                        </tr>
                                                    <?php } else { ?>
                                                        <tr>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label><?php echo "Diagnosis Center Name" ?> <small class="req"> *</small></label>
                                    <input type="text" class="form-control " id="diagnosis_center_name" name="diagnosis_center_name" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                    ...
                    <div class="ptt10">
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label>
                                        <?php echo "Diagnosis Center Name"; ?></label><small class="req"> *</small>
                                    <input type="text" name="diagnosis_center_name" class="form-control" id="diagnosis_center_names" />
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
...
<?php } ?>
                                ...
                                <!--div class="col-sm-12">
                                   <a href="#" class="pull-right" onclick="add_more()"><?php //echo $this->lang->line('add_more');    
                                                                                        ?></a>
                                </div-->
...
<div class="modal fade" id="viewModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <a href="javascript: void(0);" onclick="ipdprint('<?php echo $result['id'] ?>','<?php echo $ipdid ?>')" class="close" style="font-size:15px; padding: 4px 35px;"><i class="fas fa-print"></i></a>
                            ...
                            <div class="row">
                                <table class="table mb0 table-striped table-bordered examples">
                                    <tr>
                                        ...
                                        <th width="15%"><?php echo "Registration " . $this->lang->line('id'); ?></th>
                                        <td width="35%"><span id='patients_id'></span></td>
                                        <th width="15%"><?php echo $this->lang->line('agent'); ?></th>
                                        <td width="35%"><span id="agent_name"></span>(<span id='agent_id'></span>)</td>
                                    </tr>
                                    <tr>
...
<!--Add Charges--
<div class="modal fade" id="myChargesModalssss" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content modal-media-content">
            <div class="modal-header modal-media-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <form id="add_charges" accept-charset="utf-8" method="post" class="ptt10">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('unit')  ?>/Days</label><small class="req"> *</small>
            ...
            <div class="modal-content modal-media-content">
                <div class="modal-header modal-media-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <input id="charge_date" name="date" placeholder="" type="text" class="form-control date" value="<?php echo date('d/m/Y') ?>" />
                        </div>
                    </div>
                </div>
                <div class="modal-body pt0 pb0">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <!-- <form id="add_charges" accept-charset="utf-8"  method="post" class="ptt10" > -->
                            <table class="table table-striped table-bordered table-hover" id="chargeID">
                                <tr>
                                    <th>
                                    ...
                                    <th>
                                        <?php echo $this->lang->line('standard') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?>
                                    </th>
                                    <th>
                                        <?php echo $this->lang->line('organisation') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?>
                                    </th>
                                    <th>
                                        <?php echo $this->lang->line('unit')  ?>/Days</label><small class="req"> *</small>
                                    </th>
                                    <th>
                                        <?php echo $this->lang->line('applied') . " " . $this->lang->line('charge') . " (" . $currency_symbol . ")" ?>
                                        <small class="req"> *</small>
                                    </th>
                                </tr>
                                <tr id="rows0">
                                    <td>
                                        <select name="charge_category" id="charge_category0" style="width: 100%" class="form-control select2" onchange="getchargecode(this.value,0)">
                                            <option value="">Select</option>
                                            <?php foreach ($charge_cat as $key => $value) { ?>
                                    ...
                                    <td>
                                        <select name="code" id="code0" style="width: 100%" class="form-control select2" onchange="get_Charges(this.value, '<?php echo $result['organisation'] ?>',0)">
                                            <option value="">Select</option>
                                        </select>
                                        <span class="text-danger"><?php echo form_error('code'); ?></span>
                                    </td>
                                    <td>
                                        <input type="text" readonly name="standard_charge" id="standard_charge0" class="form-control" value="<?php echo set_value('standard_charge'); ?>">
                                        <input type="hidden" name="patient_id" value="<?php echo $result["id"] ?>">
                                        <input type="hidden" name="charge_id[]" id="charge_id0">
                                        <input type="hidden" name="org_id[]" id="org_id0">
                                        <input type="hidden" name="ipdid[]" value="<?php echo $ipdid ?>">
                                        <span class="text-danger"><?php echo form_error('standard_charge'); ?></span>
                                    </td>
                                    <td>
                                        <input type="text" readonly name="schedule_charge" id="schedule_charge0" placeholder="" class="form-control" value="<?php echo set_value('schedule_charge'); ?>">
                                        <span class="text-danger"><?php echo form_error('schedule_charge'); ?></span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" name="apply_charge[]" id="apply_charge0" class="form-control">
                                        <span class="text-danger"><?php echo form_error('apply_charge'); ?></span>
                                    </td>
                                    <td><button type="button" onclick="add_more_charge()" style="color: #2196f3" class="closebtn"><i class="fa fa-plus"></i></button></td>
                                </tr>
                            </table>
                            <div class="row">
                                <div class="box-footer">
...
<script type="text/javascript">
    ...
    $(document).ready(function(e) {
        $("#add_charges").on('submit', (function(e) {
            e.preventDefault();
            var datab = $('#add_charges').serialize();
            console.log(datab);
            $("#add_chargesbtn").button('loading');
            $.ajax({
                url: '<?php echo base_url(); ?>admin/charges/add_ipdcharges',
    ...
    function editDiagnosis(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#diagnosis_center_names").val(data.diagnosis_center_name);
    ...
    function view_prescription(id, ipdid) {
        ...
        $('#edit_deleteprescription').html("<?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_view')) { ?><a href='#prescription'' onclick='printprescription(" + id + "," + ipdid + ")'   data-original-title='<?php echo $this->lang->line('print'); ?>'><i class='fa fa-print'></i></a><?php } ?><?php if ($this->rbac->hasPrivilege('ipd_prescription', 'can_edit')) { ?><a href='#prescription'' onclick='edit_prescription(" + id + "," + ipdid + ")' data-target='#edit_prescription' data-toggle='modal'  data-original-title='<?php echo $this->lang->line('edit'); ?>'><i class='fa fa-pencil'></i></a><?php }
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        if ($this->rbac->hasPrivilege('ipd_prescription', 'can_delete')) { ?><a onclick='delete_prescription(" + id + "," + ipdid + ")'  href='#'  data-toggle='tooltip'  data-original-title='<?php echo $this->lang->line('delete'); ?>'><i class='fa fa-trash'></i></a><?php } ?>");
    ...
    function get_Charges(code, orgid, id) {
        //alert(orgid);
        //return false;
        $("#standard_charge" + id).html("standard_charge");
        $("#schedule_charge" + id).html("schedule_charge");
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if (res) {
                    ...
                    $('#standard_charge' + id).val(res.standard_charge);
                    $('#schedule_charge' + id).val(res.org_charge);
                    $('#charge_id' + id).val(res.id);
                    $('#org_id' + id).val(res.org_charge_id);

                    if (res.org_charge == null) {
                        $('#apply_charge' + id).val(res.standard_charge);
                    } else {
                        $('#apply_charge' + id).val(res.org_charge);
                    }
                } else {
                    //  $('#standard_charge').val('0');
                    // $('#schedule_charge').val('0');
    ...
    /*function getchargecodsssse(charge_category) {
        var div_data = "";
    ...
    function getchargecode(charge_category, id) {
        //alert(id);
        var div_data = "";
        $('#code' + id).html("<option value='l'><?php echo $this->lang->line('loading') ?></option>");
        $("#code" + id).select2("val", 'l');
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                $('#code' + id).html("<option value=''>Select</option>");

                $('#code' + id).append(div_data);
                $("#code" + id).select2("val", '');

                $('#standard_charge' + id).val('');
                $('#apply_charge' + id).val('');
            }
        });
    }
...
<script type="text/javascript">
    ...
    function ipdprint(id, ipdid) {
        var base_url = '<?php echo base_url() ?>';
        $.ajax({
            url: base_url + 'admin/patient/ipdprint/',
            type: 'POST',
            data: {
                recordid: id,
                ipdid: ipdid,
    ...
    function add_more_charge() {
        ...
        var table = document.getElementById("chargeID");
        var table_len = (table.rows.length);
        var id = parseInt(table_len);
        var dis = '<?php echo '"blank"' ?>';
        var div = "<td><select name='charge_category' id='charge_category" + id + "' style='width: 100%' class='form-control select2' onchange='getchargecode(this.value," + id + ")'><option value=''>Select</option><?php foreach ($charge_cat as $key => $value) { ?><option value='<?php echo $value['name'] ?>'><?php echo $value['name'] ?></option><?php } ?></select><span class='text-danger'><?php echo form_error('charge_category'); ?></span></td><td><select name='code' id='code" + id + "' style='width: 100%' class='form-control select2' onchange='get_Charges(this.value," + dis + "," + id + ")'> <option value=''>Select</option></select><span class='text-danger'><?php echo form_error('code'); ?></span></td><td><input type='text' readonly name='standard_charge' id='standard_charge" + id + "' class='form-control' value='<?php echo set_value('standard_charge'); ?>'><input type='hidden' name='charge_id[]' id='charge_id" + id + "'><input type='hidden' name='org_id[]' id='org_id" + id + "'><input type='hidden' name='ipdid[]' value='<?php echo $ipdid ?>'><span class='text-danger'><?php echo form_error('standard_charge'); ?></span></td><td><input type='text' readonly name='schedule_charge' id='schedule_charge" + id + "' placeholder='' class='form-control' value='<?php echo set_value('schedule_charge'); ?>'><span class='text-danger'><?php echo form_error('schedule_charge'); ?></span></td><td><input type='text' name='unit[]' id='unit" + id + "' class='form-control'><span class='text-danger'><?php echo form_error('unit'); ?></span></td><td><input type='text' name='apply_charge[]' id='apply_charge" + id + "' class='form-control'><span class='text-danger'><?php echo form_error('apply_charge'); ?></span></td>";

        var row = table.insertRow(table_len).outerHTML = "<tr id='rows" + id + "'>" + div + "<td><button type='button' onclick='delete_row_charge(" + id + ")' class='closebtn'><i class='fa fa-remove'></i></button></td></tr>";
