        ...
        <div class="col-md-12">
            ...
            <div class="">
                ...
                <table width="100%" class="printablea4">
                    ...
                    <tr>
                        <th><?php echo $this->lang->line('prescription'); ?> #<?php echo $result["id"] ?></th>
                        <td></td>
                        <th class="text-right"></th>
                        <th class="text-right"><?php echo $this->lang->line('date'); ?> : <?php
                                                                                            if (!empty($prescription_list[0]['date'])) {
                                                                                                echo date('d/m/Y', strtotime($prescription_list[0]['date']));
                                                                                            }
                                                                                            ?>
                        </th>
                    </tr>
                ...
                <table width="100%" class="printablea4">
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('consultant'); ?> <?php echo $this->lang->line('doctor'); ?></th>
