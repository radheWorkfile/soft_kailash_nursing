                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <li class="list-group-item listnoback">
                                ...
                                <b><?php echo $this->lang->line('agent');?></b> <a class="pull-right text-aqua"><?php echo $agent['name']."(".$agent['agent_id'].")"; ?></a>
                                            ...
                                            if (!empty($opd_details)) {
                                                ...
                                                foreach ($opd_details as $key => $value) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php echo $value['appointment_date'] . " ". date("h:iA", strtotime($value['appointment_time'])) ?></td>
