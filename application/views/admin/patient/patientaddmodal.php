...
$agent = $this->agent_model->agent_details();
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label for="address"><?php echo $this->lang->line('agent') . " " . $this->lang->line('details'); ?></label>

                                            <select name="agent_details" class="form-control">

                                                <option value=""><?php echo $this->lang->line('select') ?></option>

                                                <?php foreach ($agent as $avalue) { ?>

                                                    <option value="<?php echo $avalue['id']; ?>" <?php if (set_value('agent_details') == $avalue['id']) echo "selected"; ?>><?php echo $avalue['name'] . "(" . $avalue['agent_id'] . ")"; ?></option>
