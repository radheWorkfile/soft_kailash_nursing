...
<?php if ($this->rbac->hasPrivilege('opd_bill', 'can_view')) { ?>         
    ...
    <?php } else { ?> 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php echo number_format($total + $visit_charge + $revisit_charge,2); ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php echo number_format($paid_amount,2); ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php echo number_format($total + $visit_charge + $revisit_charge - $paid_amount,2); ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php echo number_format($result['other_charge'],2) ?></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right fontbold20"><?php echo number_format($result['tax'],2) ?></td>
                                                        ...
                                                        <?php if (!empty($paid_amount)) { ?> 
                                                            ...
                                                            <?php echo number_format($result['net_amount'],2) ?>
...
//if($paid_amount <= ($total+$visit_charge+$revisit_charge) ){ 
                                            ...
                                            if ($result["status"] != "paid") {
                                                ...
                                                <input data-loading-text="<?php echo $this->lang->line('processing') ?>" type="submit" style="display:none" id="save_button" name="" value="Discharge" class="btn btn-sm btn-info"/>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>
                                            ...
                                            <?php echo $this->lang->line('report') . " " . $this->lang->line('type'); ?><small class="req"> *</small> 
...
<script type="text/javascript">
    ...
    $(document).ready(function (e) {
        ...
        $("#add_bill").on('submit', (function (e) {
            ...
            if (confirm('Once Discharge You Are Not Able To Do Any Changes On This Patient Section! Are you sure?')) {
