                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $report) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>admin/patient/ipdprofile/<?php echo $report['pid']; ?>/<?php echo trim($report['ipd_no'],"IPDN");; ?>"><?php echo $report['patient_name'] ?>
                                                    </a>
                                                </td> 
                                                ...
                                                <td>
                                                    <a href="<?php echo base_url(); ?>admin/patient/discharge_cerificate/<?php echo $report['pid']; ?>/<?php echo trim($report['ipd_no'],"IPDN");; ?>"target="_blank"><i class="fa fa-print"></i>
                                                    </a>
                                                </td>
                                            </tr>
        <?php
