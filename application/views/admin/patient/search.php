                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="box-tools pull-right">
                            ...
                            <?php if ($title !== 'old_patient') { ?>
                                ...
                                ?>
                                <!--  <a href="<?php //echo base_url('admin/patient/getoldpatient');  
                                                ?>" class="btn btn-primary btn-sm"><i class="fa fa-reorder"></i>  <?php //echo $this->lang->line('old') . " " . $this->lang->line('patient')  
                                                                                                                                                                        ?></a>  -->
                            <?php
                                //}
                            }
                                    ...
                                    ?>
                                        ...
                                        ?>
                                                <tr class="">
                                                    ...
                                                    <!--</td>-->
                                                    <td><?php echo $student['last_visit_date']. " ". $student['last_visit_time'] ?></td>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input id="admission_date" name="appointment_date" placeholder="" type="datetime-local" class="form-control" />
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label><?php echo $this->lang->line('appointment') . " " . $this->lang->line('date'); ?></label>
                                                <small class="req">*</small>
                                                <input id="revisit_date" name="appointment_date" placeholder="" type="text" class="form-control date" />
                                                <span class="text-danger"><?php echo form_error('appointment_date'); ?></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="exampleInputFile">
                                                    <?php echo $this->lang->line('organisation'); ?></label>
                                                <div>
                                                    <select class="form-control" name='organisation_name' onchange="get_Chargesrevisit('')" id="revisit_organisation">
                                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                                        <?php foreach ($organisation as $orgkey => $orgvalue) {
                                                        ?>
                                                            <option value="<?php echo $orgvalue["id"]; ?>"><?php echo $orgvalue["organisation_name"] ?></option>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <label for="exampleInputFile">
                                                    ...
                                                    <select name="agent_details" id="" class="form-control">
