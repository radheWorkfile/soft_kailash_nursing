                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                ...
                                foreach ($resultlist as $pharmacy) {
                                    $medicine = $this->pharmacy_model->getAllSupplierDetails($pharmacy['id']); ?>
                                    <tr class="">
                                        <td>
                                            <?php if ($this->rbac->hasPrivilege('purchase', 'can_view')) { ?>
                                                <a href="#" onclick="viewDetail('<?php echo $pharmacy['id'] ?>')" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>"><?php echo $pharmacy['purchase_no']; ?></a>
                                            <?php } ?>
                                        </td>

                                        <td><?php echo $pharmacy['supplier_category']; ?></td>
                                        <td><?php echo $medicine[0]['medicine_name']; ?>
                                        ...
                                        <td class="">
                                            ...
                                            <a href="#" onclick="viewDetail(<?php echo $pharmacy['id'] ?>,<?php echo $pharmacy['purchase_no'] ?>,<?php echo $pharmacy['supplier_id'] ?>)" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-4 col-xs-7">
                                <input name="date" id="date_supplier" type="text" value="<?php echo date($this->customlib->getSchoolDateFormat(true, true)) ?>" class="form-control date" />
                                            ...
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        <h4 style="float: right;font-size: 12px; padding-left: 5px;"> %</h4><input type="text" placeholder="Discount" value="" name="discount_percent" id="discount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control" />
                                                    </td>
