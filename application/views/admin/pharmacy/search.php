...
<style type="text/css">
    ...
    .total-amo-head{float:right;padding-right:2rem;}
    .total-amo{color:#c53d3d;font-weight:800;}
</style>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                ...
                                <?php } else {
                                    ...
                                    foreach ($resultlist as $pharmacy) {
                                        ...
                                        <tr class="<?php echo $color ?>">
                                            ...
                                            <?php $total = $pharmacy['total_qty'] *  $pharmacy['mrp']; ?>
                            ...
                            <div class="">
                            <!-- $total_resultlist = $resultlist['total_qty'] *  $resultlist['mrp']; -->
                            <?php foreach($resultlist as $res):?>
                                <?php $sum = $sum+$res['total_qty'] * $res['mrp'];?>  
                            <?php endforeach;?>
                            <p class="total-amo-head">
                                    <span class="total-amo">Total Amo -</span>
