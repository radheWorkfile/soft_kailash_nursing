                        ...
                        <table class="printablea4">
							...
							<tr>
                                ...
                                <td colspan="2" class="text-right ipdbilltable">
                                    <input type="text" placeholder="Paid Amount" value="<?php echo $result["paid_amt"] ?>" name="paid_amount" id="editpaid_amount" style="width: 30%; float: right" class="form-control" onchange="editdue()" />
                                </td>
                            </tr>
                            <tr>
                                <th><?php echo $this->lang->line('due') ." ".$this->lang->line('amount'). " (" . $currency_symbol . ")"; ?></th>
                                <td colspan="2" class="text-right ipdbilltable">
                                    <input type="text" placeholder="Due Amount" value="<?php echo $result["due_amt"] ?>" name="due_amount" id="editdue_amount" style="width: 30%; float: right" class="form-control" readonly/>
                                </td>
                            </tr>
...
<script type="text/javascript">
  ...
  function editdue(){
    var total = $("#editnet_amount").val();
    var paid = $("#editpaid_amount").val();
    var due_amt = total - paid;
    $("#editdue_amount").val(due_amt);
    //alert(total);
  }
</script>
