                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class="text-right"><?php echo $this->lang->line('total') . " " . '(' . $currency_symbol . ')'; ?></th>
                                  	...
                                  	<th class="text-right"><?php echo $this->lang->line('due') ." ".$this->lang->line('amount') . " " . '(' . $currency_symbol . ')'; ?></th>
                                    ...
                                    ?>
                                        ...
                                        <tr class="">
                                            ...
                                            <td class="text-right"><?php echo number_format($bill['net_amount'],2); ?></td>
                                          	...
                                          	<td class="text-right"><?php echo number_format($bill['paid_amt'],2); ?></td>

                                          	<td class="text-right"><?php echo number_format($bill['due_amt'],2); ?></td>

                                            <td class="pull-right">

                                                <a href="#" onclick="viewDetail(<?php echo $bill['id'] ?>,<?php echo $bill['bill_no'] ?>,<?php echo $bill['patient_id'] ?>)" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>">

                                                    <i class="fa fa-reorder"></i>

                                                </a>

                                                <a href="#" onclick="viewDetail(<?php echo $bill['id'] ?>,<?php echo $bill['bill_no'] ?>,<?php echo $bill['patient_id'] ?>)" class="btn btn-default btn-xs" data-toggle="tooltip" title="<?php echo $this->lang->line('print'); ?>">
                    ...
                    <div class="col-lg-6 col-sm-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-sm-3 col-xs-9">
                                ...
                                <input name="date" id="date_pharmacy" type="text" value="<?php echo date($this->customlib->getSchoolDateFormat(true, true)) ?>" class="form-control date" />
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="tableID">
                                            ...
                                            <tr id="row0">
                                                ...
                                                <!--<td width="16%" >
                                                    ...
                                                    <select class="form-control" name='medicine_category_id[]' onchange="getmedicine_name(this.value, '0')" style="display:none;">
                                                ...
                                                <td width="24%">
                                                    ...
                                                    <select class="form-control select2" style="width:100%" onchange="getbatchnolist(this.value, 0)" id="medicine_name0" name='medicine_name[]'>
                                                        ...
                                                        <?php foreach ($medicineName as $dkey => $dvalue) {

                                                        ?>

                                                            <option value="<?php echo $dvalue["id"]; ?>"><?php echo $dvalue["medicine_name"] ?>
                                            ...
                                            <table class="printablea4">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        ...
                                                        <input type="text" placeholder="Discount" value="" name="discount_percent" id="discount_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right ipdbilltable">
                                                        ...
                                                        <input type="text" placeholder="Tax" name="tax_percent" value="" id="tax_percent" style="width: 50%; float: right;font-size: 12px;" class="form-control" />
                                                ...
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-right ipdbilltable">
                                                        ...
                                                        <input type="text" placeholder="Net Amount" value="0" name="net_amount" id="net_amount" style="width: 30%; float: right" class="form-control" />
                                              	...
                                              	<tr>
                                                    ...
                                                    <td colspan="2" class="text-right ipdbilltable">
                                                        ...
                                                        <input type="text" placeholder="Paid Amount" value="0" name="paid_amount" id="paid_amount" style="width: 30%; float: right" class="form-control" onchange="due()" />
                                              	...
                                              	<tr>
                                                    ...
                                                    <th><?php echo $this->lang->line('due') ." ".$this->lang->line('amount'). " (" . $currency_symbol . ")"; ?></th>

                                                    <td colspan="2" class="text-right ipdbilltable">

                                                        <input type="text" placeholder="Due Amount" value="0" name="due_amount" id="due_amount" style="width: 30%; float: right" class="form-control" readonly/>
...
<script type="text/javascript">
  ...
  function due(){
    ...
    var total = $("#net_amount").val();

    var paid = $("#paid_amount").val();

    var due_amt = total - paid;
