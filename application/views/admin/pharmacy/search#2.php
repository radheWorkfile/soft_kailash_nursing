                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                            ...
                            <thead>
                                <tr>
                                   <th><?php echo "Batch No" ?></th>
                                    ...
                                    <th><?php echo "M.R.P" ?></th>
                                    <th ><?php echo $this->lang->line('available') . " " . $this->lang->line('qty'); ?></th>
                                    <th ><?php echo $this->lang->line('available') . " " . $this->lang->line('qty') . " " . $this->lang->line('amount'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <?php } else {
                                    ...
                                    foreach ($resultlist as $pharmacy) {
                                        ...
                                        <tr class="<?php echo $color ?>">
                                          <td> <?php echo $pharmacy['batch_no']; ?></td>
                                            <td>
                                            ...
                                            <?php 
                                            $total = $pharmacy['total_qty'] *  $pharmacy['mrp']; 

                                            $total_avl_qty_price  = $total_avl_qty_price + $total;
                                            ...
                                            <td><?php echo $pharmacy['mrp']; ?></td>
                                            <td><?php echo $pharmacy['total_qty'] ?></td>
                        ...
                        <h3 class="text-center ">
                            <span style="background-color: #00030f;
    padding: 10px;
    color: white;
    border-radius: 5%;
    box-shadow: -20px 15px 20px 9px black;">
                                <?php echo "Total Available Stock Price=<span class='text-danger' >".$total_avl_qty_price.'</span>';?>
                            </span>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 paddlr">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('gst') . " (%)" ?></label>
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('gst') . " " . $this->lang->line('a/c'); ?></label>
