            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title titlefix">Registration <?php echo $this->lang->line('details'); ?></h3>
                            ...
                            <tbody>
                                ...
                                <?php
                                        ...
                                        foreach ($resultlist as $appointment) {
                                            ...
                                            $agent = $this->agent_model->get_agent($appointment['agent_details']);
                                            ?>
                                <tr class="">
                                    <td>
                                        <a href="#" 
                                    ...
                                    <td><?php
                                        ...
                                        ?></td>
                                    <td><?php echo $appointment['date']. " ". $appointment['time']; ?></td>
                                    <td><?php echo $appointment['mobileno']; ?></td>
                                    <td><?php echo $appointment['gender']; ?></td>
                                    <td><?php echo $appointment['name'] . " " . $appointment['surname']; ?></td>
                                    <td><?php echo empty($appointment['agent_details']) ? "Direct" : $agent['name']."(".$agent['agent_id'].")"; ?></td>
