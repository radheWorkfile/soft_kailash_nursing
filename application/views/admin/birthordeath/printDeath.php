        ...
        <div class="col-md-12">
            <div class="">
                ...
                <table width="100%" class="printablea4">
                    <tr>
                        <td align="text-left">
                            <h5><?php echo $this->lang->line('opd_ipd_no') . " #"; ?><?php echo $result["opdipd_no"] ?></h5>
                        </td>
                        <td align="right">
                            <h5><?php echo $this->lang->line('death_date') . " : "; ?><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['death_date'])) ?></h5>
                        </td>
                    </tr>
                </table>
