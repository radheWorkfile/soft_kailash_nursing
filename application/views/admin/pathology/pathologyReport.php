            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('patient') . " " . $this->lang->line('report'); ?></h3>
                    </div>

                    <form role="form" action="<?php echo site_url('admin/pathology/pathologyreport') ?>" method="post" class="">
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('pathology') . " " . $this->lang->line('patient') . " " . $this->lang->line('report'); ?></div>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $report) {
                                            ...
                                            ?>
                                                ...
                                                <td><?php echo $report['test_center_name']; ?></td>
