                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                <th><?php echo $this->lang->line('test') . " Center " . $this->lang->line('name'); ?></th>
                            ...
                            <tbody>
                                ...
                                if (empty($resultlist)) {
                                    ...
                                    foreach ($resultlist as $student) {
                                        ?>
                                        <tr class="">
                                            <td><?php echo $student['test_center_name']; ?></td>
                                            <td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('test') . " " . "Center"." ". $this->lang->line('name'); ?></label>
                                        <small class="req"> *</small> 
                                        <input type="text" name="test_center_name" class="form-control">
                                        <span class="text-danger"><?php echo form_error('test_center_name'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <small class="req">*</small> 
                                        <div>
                                            <select class="form-control select2" style="width: 100%" onchange="getchargecode(this.value, 'standard_charge')" name='charge_category_id' >
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label><?php echo $this->lang->line('test') . " Center " . $this->lang->line('name'); ?></label>
                                        <small class="req"> *</small> 
                                        <input type="text" name="test_center_name" id="test_center_name" class="form-control" value="<?php echo set_value('test_center_name'); ?>">
                                        <span class="text-danger"><?php echo form_error('test_center_name'); ?></span>
                                    </div>
                                </div>
                                <div class="col-sm-3">
                        ...
                        <div class="table-responsive">
                            <table class="table mb0 tablelr0space table-striped table-bordered examples">
                                ...
                                <tr>
                                    ...
                                    <th width="15%"><?php echo $this->lang->line('test') . " Center " . $this->lang->line('name'); ?></th>
                                    <td width="35%"><span id='test_center_names'></span></td>
                                </tr>
                            </table>
                        </div>
                    </div><!--./row--> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <select class="form-control select2" style="width:100%" name='consultant_doctor' id="consultant_doctor" required>
...
<script type="text/javascript">
    ...
    function getRecord(id) {
        ...
        $.ajax({
            ...
            success: function (data) {
                $("#id").val(data.id);
                $("#test_center_name").val(data.test_center_name);
    ...
    function viewDetail(id) {
        $.ajax({
            ...
            dataType: 'json',
            success: function (data) {
                $("#test_center_names").html(data.test_center_name);
