            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title"><?php echo $this->lang->line('ot') . " " . $this->lang->line('report'); ?></h3>
                    </div>
                    <form role="form" action="<?php echo site_url('admin/operationtheatre/otreport') ?>" method="post" class="">
...
<?php } ?>
                    ...
                    <div class="box border0 clear">
                        ...
                        <div class="box-body table-responsive">
                            <div class="download_label"><?php echo $this->lang->line('ot') . " " . $this->lang->line('report'); ?></div>
                                ...
                                <tbody>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $report) {
                                            ...
                                            ?>
                                            <tr>
                                                <td><?php echo date("d/m/Y H:i", strtotime($report['date']));//date($this->customlib->getSchoolDateFormat(), $this->customlib->dateyyyymmddTodateformat($report['date']));
                                            ?>
                                                </td>
                                    ...
                                    <tr class="box box-solid total-bg">
                                        <td colspan='10' class="text-right"> <?php echo $this->lang->line('total') . " :" . $currency_symbol . $total; ?>
                                        </td>
                                    </tr> 
<?php } ?>
                            </table>
