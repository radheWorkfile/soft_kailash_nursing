            ...
            <div class="">
                ...
                <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th width="25%"><?php echo $this->lang->line('operation_type') . "" . $this->lang->line('type'); ?></th>
                    ...
                    <tr>
                        ...
                        <th width="25%"><?php echo $this->lang->line('operation') . " " . $this->lang->line('date'); ?></th>

                        <td width="25%"><?php echo $result["date"]; ?></td>

                        <th width="25%"><?php echo $this->lang->line('consultant') . " " . $this->lang->line('doctor'); ?></th>
                    ...
                    <tr>
                        ...
                        <th width="25%"><?php echo "Assistant " . $this->lang->line('consultant'); ?>1</th>

                        <td width="25%"><?php echo $result["ass_consultant_1"]; ?></td>

                        <th width="25%"><?php echo "Assistant " . $this->lang->line('consultant'); ?>2</th>

                        <td width="25%"><?php echo $result["ass_consultant_2"]; ?></td>

                    </tr>

                    <tr>

                        <th width="25%"><?php echo $this->lang->line('anesthetist'); ?></th>

                        <td width="25%"><?php echo $result["anesthetist"]; ?></td>

                        <th width="25%"><?php echo $this->lang->line('anesthetist'); ?> Type</th>

                        <td width="25%"><?php echo $result["anaethesia_type"]; ?></td>
                    ...
                    <tr>
                        ...
                        <td><?php echo $result['ot_technician']; ?></td>

                        <th width="25%"><?php echo $this->lang->line('ot'); ?> Assistant</th>

                        <td width="25%"><?php echo $result["ot_assistant"]; ?></td>
