                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="datetime-local" value="<?php //echo set_value('email');     ?>" id="date" name="date" class="form-control">
...
<div class="modal fade" id="myModaledit" role="dialog" aria-labelledby="myModalLabel" style="overflow-x: hidden !important;
                                ...
                                <table class="table table-striped table-bordered table-hover" id="tableID">
                                    ...
                                    <tr id="row0">
                                        ...
                                        <td>
                                            ...
                                            <input type="text" name="date[]" value="<?php echo set_value('date', date($this->customlib->getSchoolDateFormat(true, true))); ?>" class="form-control date">
