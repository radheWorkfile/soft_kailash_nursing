                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="datetime-local" name="date_of_issue" id="dates_of_issue" class="form-control">
                    ...
                    <div class="row ptt10">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label><?php echo $this->lang->line('issue') . " " . $this->lang->line('date'); ?></label>
                                <small class="req"> *</small> 
                                <input type="datetime-local" name="date_of_issue" id="date_of_issue" value="" class="form-control">
                                <span class="text-danger"><?php echo form_error('date_of_issue'); ?></span>
                            </div>
                        </div>
