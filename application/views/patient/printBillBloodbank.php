                ...
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            ...
                            <td align="right"><h5><?php echo $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getSchoolDateFormat(true, true), strtotime($result['date_of_issue'])) ?></h5>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="printablea4" cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            ...
                            <td width="30%" align="left"><?php echo $result["donorname"]; ?></td>
                        </tr>
                        <tr>
                            <th width="20%"><?php echo $this->lang->line('blood') . " " . $this->lang->line('group'); ?></th>
                            <td width="25%"><?php echo $result["bloodgroup"]; ?></td>
                    ...
                    <div class="pprinta4">
                        <img src="<?php
                                    if (!empty($print_details[0]['print_footer'])) {
                                        echo base_url() . $print_details[0]['print_footer'];
                                    }
                                    ?>" class="img-responsive" style="height:100px; width: 100%;">
                    </div>
                <?php } ?>   
