...
<html <?php //echo $this->customlib->getRTL();     ?>>
    ...
    <head>
        ...
        <title><?php echo $this->setting_model->getCurrentSchoolName();//$this->customlib->getAppName(); ?></title>       
        ...
        <link href="<?php echo base_url($front_setting->fav_icon); ?>" rel="apple-touch-icon">

        <link href="<?php echo base_url($front_setting->fav_icon); ?>" rel="apple-touch-icon" sizes="72x72">

        <link href="<?php echo base_url($front_setting->fav_icon); ?>" rel="apple-touch-icon" sizes="114x114">

        <link href="<?php echo base_url($front_setting->fav_icon); ?>" rel="apple-touch-icon" sizes="144x144">
            ...
            <div class="topaleart">
                ...
                <div class="slidealert">
                    ...
                    <div class="alert alert-dismissible topaleart-inside">
                        ...
                        <!--p class="palert">Alert! You are using unregistered version of school alarm. Please <a  href="#" class="purchasemodal">click here</a> to register your purchase code for school alarm.</p!-->
        ...
        <div class="wrapper">
            ...
            <header class="main-header" id="alert">            
                ...
                <a href="<?php echo base_url(); ?>admin/admin/dashboard" class="logo">                 
                    ...
                    <span class="logo-lg"><img src="<?php echo $logo_image; ?>" alt="<?php echo $this->customlib->getAppName() ?>"style="width:100%" /></span>
