...
<html dir="<?php echo ($front_setting->is_active_rtl) ? "rtl" : "ltr"; ?>" lang="<?php echo ($front_setting->is_active_rtl) ? "ar" : "en"; ?>">
    <head>
        ...
        <link href="<?php echo $base_assets_url; ?>css/responsive.css" rel="stylesheet">
...
<br><br>
        ...
        <?php echo $footer; ?>
        <!-- main jQuery -->
<script src="<?php echo $base_assets_url; ?>js/jquery-1.11.1.min.js"></script>
<!-- Wow Script -->
<script src="<?php echo $base_assets_url; ?>js/wow.js"></script>
<!-- bootstrap -->
<script src="<?php echo $base_assets_url; ?>js/bootstrap.min.js"></script>
<!-- bx slider -->
<script src="<?php echo $base_assets_url; ?>js/jquery.bxslider.min.js"></script>
<!-- count to -->
<script src="<?php echo $base_assets_url; ?>js/jquery.countTo.js"></script>
<!-- owl carousel -->
<script src="<?php echo $base_assets_url; ?>js/owl.carousel.min.js"></script>
<!-- validate -->
<script src="<?php echo $base_assets_url; ?>js/validation.js"></script>
<!-- mixit up -->
<script src="<?php echo $base_assets_url; ?>js/jquery.mixitup.min.js"></script>
<!-- easing -->
<script src="<?php echo $base_assets_url; ?>js/jquery.easing.min.js"></script>
<!-- gmap helper -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAHzPSV2jshbjI8fqnC_C4L08ffnj5EN3A"></script>
<!--gmap script-->
<script src="<?php echo $base_assets_url; ?>js/gmaps.js"></script>
<script src="<?php echo $base_assets_url; ?>js/map-helper.js"></script>
<!-- fancy box -->
<script src="<?php echo $base_assets_url; ?>js/jquery.fancybox.pack.js"></script>
<script src="<?php echo $base_assets_url; ?>js/jquery.appear.js"></script>
<!-- isotope script-->
<script src="<?php echo $base_assets_url; ?>js/isotope.js"></script>
<script src="<?php echo $base_assets_url; ?>js/jquery.prettyPhoto.js"></script> 
<script src="<?php echo $base_assets_url; ?>js/jquery.bootstrap-touchspin.js"></script>
<!-- jQuery timepicker js -->
<script src="<?php echo $base_assets_url; ?>assets/timepicker/timePicker.js"></script>
<!-- Bootstrap select picker js -->
<script src="<?php echo $base_assets_url; ?>assets/bootstrap-sl-1.12.1/bootstrap-select.js"></script>                               
<!-- Bootstrap bootstrap touchspin js -->
<!-- jQuery ui js -->
<script src="<?php echo $base_assets_url; ?>assets/jquery-ui-1.11.4/jquery-ui.js"></script>
<!-- Language Switche  -->
<script src="<?php echo $base_assets_url; ?>assets/language-switcher/jquery.polyglot.language.switcher.js"></script>
<!-- Html 5 light box script
<script src="<?php echo $base_assets_url; ?>assets/html5lightbox/html5lightbox.js"></script>-->


<!-- revolution slider js -->
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/jquery.themepunch.tools.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/jquery.themepunch.revolution.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.actions.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.carousel.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.kenburn.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.layeranimation.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.migration.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.navigation.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.parallax.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.slideanims.min.js"></script>
<script src="<?php echo $base_assets_url; ?>assets/revolution/js/extensions/revolution.extension.video.min.js"></script>
