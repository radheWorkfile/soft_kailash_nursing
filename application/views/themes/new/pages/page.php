...
if ($page_form) {
    if (!empty($form)) {
        ...
        echo '<section class="breadcrumb-area" style="background-image: url('.$page['feature_image'].');">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div>
        ...
        <section class="breadcrumb-area" style="background-image: url(<?php echo $fimg; ?>);">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="breadcrumbs">
                            <h1><?php echo $page['slug']; ?></h1>
                        </div>
                    </div>
                </div>
            </div>
